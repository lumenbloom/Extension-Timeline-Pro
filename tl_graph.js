...
/**
 * Retrieves the 0-based chat message index of a given node in a graph.
 * The index is determined based on the number of ancestral nodes minus one (excluding root).
 *
 * @param {Object} node - The Cytoscape node object whose chat message index is to be determined.
 * @returns {number} The 0-based chat message index of the given node.
 */
export function getNodeDepth(node) {
    ...
    // Subtract root node which has no corresponding chat message
